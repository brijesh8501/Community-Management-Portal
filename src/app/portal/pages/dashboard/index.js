...
import { pageTitle } from "./pageConfig";
...
const Dashboard = () => {
    ...
    return (
        ...
        <div className="container">
            <h1 className="visually-hidden">{`${pageTitle.en} / ${pageTitle.guj}`}</h1>
            <section class="section-wrapper d-none" id="family-tree-section">
                <h2 className="mb-0">Your Family Tree / તમારું કુટુંબ વૃક્ષ</h2>
                <div>
